...
pub const LIGHT_YELLOW: Color = Color::Rgb {
    r: 255,
    g: 255,
    b: 224,
};
pub const LIGHT_CYAN: Color = Color::Rgb {
    r: 224,
    g: 255,
    b: 255,
};
pub const LIGHT_MAGENTA: Color = Color::Rgb {
    r: 255,
    g: 224,
    b: 255,
};
pub const LIGHT_GREY: Color = Color::Rgb {
    r: 211,
    g: 211,
    b: 211,
};
...
pub const DARK_PURPLE: Color = Color::Rgb {
    r: 75,
    g: 0,
    b: 130,
};
pub const DARK_TEAL: Color = Color::Rgb {
    r: 0,
    g: 139,
    b: 139,
};
pub const DARK_BROWN: Color = Color::Rgb {
    r: 101,
    g: 67,
    b: 33,
};
...
pub const COLOR_NOTICE: Color = Color::Rgb {
    r: (255),
    g: (90),
    b: (0),
};
