...
pub fn list() -> Vec<(&'static str, Color)> {
    vec![
        ...
        ("Cyan", CYAN), ("Magenta", MAGENTA), ("White", WHITE), ("Grey", GREY),
        ("Black", BLACK), ("Orange", ORANGE), ("Pink", PINK), ("Purple", PURPLE),
        ("Teal", TEAL), ("Brown", BROWN), ("Light Blue", LIGHT_BLUE),
        ("Light Green", LIGHT_GREEN), ("Light Yellow", LIGHT_YELLOW),
        ("Light Cyan", LIGHT_CYAN), ("Light Magenta", LIGHT_MAGENTA),
        ("Light Grey", LIGHT_GREY), ("Dark Grey", DARK_GREY), ("Dark Blue", DARK_BLUE),
        ("Dark Orange", DARK_ORANGE), ("Dark Pink", DARK_PINK),
        ("Dark Purple", DARK_PURPLE), ("Dark Teal", DARK_TEAL), ("Dark Brown", DARK_BROWN)
    ]
}
